...
class Command(BaseCommand):
    help = 'LAYER 1 : Import IGDB avec filtres qualité (Main, Remake, Remaster)'
    ...
    def handle(self, *args, **options):
        ...
        # 3. Récupération Jeux (Filtres Qualité)
        # - game_type = (0, 8, 9) : Garde Main Game, Remake, Remaster.
        # - cover != null : Uniquement les jeux avec jaquette.
        # - sort total_rating_count : Tri par popularité globale (Critiques + Joueurs).
        body_games = f"fields name, slug, rating, cover.url, platforms.name, genres.name, release_dates.y, game_type; where game_type = (0, 8, 9) & cover != null; sort total_rating_count desc; limit {limit}; offset {offset};"
        ...
        # 4. Récupération Temps de jeu (IGDB)
        # On récupère les IDs pour faire une requête groupée
        ...
        # Création d'un dictionnaire {game_id: heures} pour accès rapide
        times_map = {}
        ...
        for data in games_data:
            ...
            # Nettoyage de l'URL de l'image (t_thumb -> t_cover_big)
            cover_url = ""
            ...
            try:
                # Update ou Create pour éviter les doublons
